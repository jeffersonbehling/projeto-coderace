...
Plugin::load('SignUp/User', ['bootstrap' => false, 'routes' => true]);

Plugin::load('Logs', ['bootstrap' => false, 'routes' => true]);
...
Plugin::load('Accounts/Base', ['bootstrap' => false, 'routes' => true]);

Plugin::load('Accounts/Admin', ['bootstrap' => false, 'routes' => true]);

Plugin::load('Accounts/Profile', ['bootstrap' => false, 'routes' => true]);

Plugin::load('Accounts/Auth', ['bootstrap' => true, 'routes' => true]);

Plugin::load('Accounts/Authz', ['bootstrap' => false, 'routes' => true]);

Plugin::load('LoggingPack' , ['autoload' => true]);
...
Plugin::load('Interests', ['bootstrap' => false, 'routes' => true]);
