...
namespace Accounts\Admin\Model\Behavior;
...
class RegisterBehavior extends Behavior
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->requiredEmail = (bool)Configure::read('Users.Email.required');
        $this->useEmail = true;
    ...
    public function register($user, $data, $options)
    {
        ...
        $this->_table->isValidateEmail = true;
    ...
    {
        if ($name === 'default') {
            return $this->_emailValidator($validator, $this->requiredEmail);
        }
    }
