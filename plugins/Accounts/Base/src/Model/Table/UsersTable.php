...
namespace Accounts\Base\Model\Table;
...
class UsersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->addBehavior('Accounts/Admin.Register');
        $this->addBehavior('Accounts/Base.Password');
        ...
        $this->searchManager()
            ->add('username', 'Search.Callback', [
                'callback' => function ($query, $args, $manager) {
                    $pieces = explode(' ', trim($args['username']));
                    foreach ($pieces as $value) {
                        $query->where([
                                'or' => [
                                    "Users.username LIKE" => "%$value%",
                                    "Users.email LIKE" => "%$value%",
        ...
        $this->belongsTo('Persons', [
            ...
            'className' => 'Persons.SocialAccounts'
        ]);
    }
