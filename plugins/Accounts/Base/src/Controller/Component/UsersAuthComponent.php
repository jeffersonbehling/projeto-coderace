...
namespace Accounts\Base\Controller\Component;
...
class UsersAuthComponent extends Component
{
    ...
    const EVENT_BEFORE_CHANGE_PASSWORD = 'Users.Component.UsersAuth.beforeChangePassword';
    const EVENT_AFTER_CHANGE_PASSWORD = 'Users.Component.UsersAuth.afterChangePassword';
    const EVENT_AFTER_REJECT_ACCOUNT = 'Users.Component.UsersAuth.afterRejectAccount';
    const EVENT_AFTER_ACCEPT_ACCOUNT = 'Users.Component.UsersAuth.afterAcceptAccount';
    const EVENT_AFTER_ENABLE_ACCOUNT = 'Users.Component.UsersAuth.afterEnableAccount';
    const EVENT_AFTER_DISABLE_ACCOUNT = 'Users.Component.UsersAuth.afterDisableAccount';
